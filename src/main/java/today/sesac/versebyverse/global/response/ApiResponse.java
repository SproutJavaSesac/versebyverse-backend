...
/**
 * 일관적인 Rest API 응답을 만듭니다. 성공, 실패 여부에 따라 다른 형태로 응답합니다.
 *
...
public class ApiResponse<T> {
     ...
     * @return 성공 결과가 담긴 {@code ApiResponse<T>}
     */
     ...
     * @return 오류 내용이 담긴 {@code ApiResponse<ErrorResponse>}
     */
     ...
     *
     * @param errorResponse API 요청의 오류 내용
     * @return 오류 내용이 담긴 {@code ApiResponse<List<ErrorResponse>>}
     */
    public static ApiResponse<List<ErrorResponse>> fail(List<ErrorResponse> errorResponse) {

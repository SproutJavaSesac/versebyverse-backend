 ...
 * 나타내기 위한 dto.
 */
//image값이 null인 경우도 있어서 image는 final 제외 -> 빌더쓰면 안 붙여도 됨
@Getter
...
public class PostSummaryResponseDto {
    ...
    /**
     * Service에서 Post객체를 Dto 객체로 바꾸기 위한 정적 메소드
     * Concept enum타입을 문자열로 변환.
     *
     * @param post          Post 객체
     * @param reactionCount 반응 갯수(현재 0으로 고정)
     * @param commentCount  댓글 갯수
     * @return Page 객체 내부에 들어가는 Dto객체
     */
    public static PostSummaryResponseDto of(Post post, int reactionCount, int commentCount) {

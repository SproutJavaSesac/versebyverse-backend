...
//        Long memberId = userPrincipal.getMemberId();
    ...
    public ApiResponse<MyInfoGetResponseDto> getMemberInformation(
        ...
        MyInfoGetResponseDto myInfoGetResponseDto = memberService.getMemberInformation(
                memberId);
    ...
    public ApiResponse<MyInfoEditResponseDto> editMemberInformation(
        ...
        MyInfoEditResponseDto myInfoEditResponseDto = memberService.editMemberInformation(
                memberId,

...
- 모든 필드는 필수: title, conceptType, emotionType, content
...
{"title": "변환된 제목", "conceptType": "CONCEPT_TYPE", "emotionType": "EMOTION_TYPE", "content": "변환된
내용"}

## example

input: {"title": "힘든 하루", "conceptType": "CLASSICAL_POETRY", "content": "요즘 회사에서 일이 너무 많아서 지치는 느낌이야.
주말에도 푹 쉬지를 못하니까 더 힘든 것 같아."}  
output: {"title": "고단한 일상", "conceptType": "CLASSICAL_POETRY", "emotionType": "SAD", "content": "일천

...
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (1, 1, '오늘 정말 행복한 하루였어요. 수정 전 내용.', '오늘 정말 행복한 하루였습니다. AI가 다듬은 내용.', '행복한 날',
        'https://placehold.co/600x400?text=Post+1', false, false, false, 'HAPPY', 'ESSAY', NOW(),
        NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (2, 1, '길을 잃어서 슬펐어요.', '길을 잃어 잠시 슬픔에 잠겼습니다.', '슬픈 날',
        'https://placehold.co/600x400?text=Post+2', false, false, false, 'SAD', 'POETRY', NOW(),
        NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (3, 1, '버스가 눈앞에서 지나가서 화가 났어요.', '버스가 눈앞에서 지나가 화가 치밀어 올랐습니다.', '화나는 날',
        'https://placehold.co/600x400?text=Post+3', false, false, false, 'ANGRY', 'DRAMA', NOW(),
        NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (4, 1, '선물 받아서 신나요!', '생각지도 못한 선물에 마음이 들뜹니다!', '신나는 날',
        'https://placehold.co/600x400?text=Post+4', false, false, false, 'EXCITED', 'NOVEL', NOW(),
        NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (5, 1, '이게 맞나? 혼란스러워요.', '무엇이 옳은 길인지 혼란스럽습니다.', '혼란스러운 날',
        'https://placehold.co/600x400?text=Post+5', false, false, false, 'CONFUSED',
        'CLASSICAL_POETRY', NOW(), NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (6, 1, '스스로가 자랑스러워요.', '오늘의 성취가 저를 자랑스럽게 만듭니다.', '자랑스러운 날',
        'https://placehold.co/600x400?text=Post+6', false, false, false, 'PROUD', 'ESSAY', NOW(),
        NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (7, 1, '행복한 하루의 기록', '행복으로 가득했던 하루를 기록합니다.', '행복 기록',
        'https://placehold.co/600x400?text=Post+7', false, false, false, 'HAPPY', 'POETRY', NOW(),
        NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (8, 1, '옛날 생각이 나서 슬퍼요.', '문득 떠오른 옛 생각에 마음이 아려옵니다.', '추억과 슬픔',
        'https://placehold.co/600x400?text=Post+8', false, false, false, 'SAD', 'DRAMA', NOW(),
        NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (9, 1, '부당한 일에 화가 나요.', '세상의 부당함에 분노를 느낍니다.', '정의로운 분노',
        'https://placehold.co/600x400?text=Post+9', false, false, false, 'ANGRY', 'NOVEL', NOW(),
        NOW());
INSERT INTO posts(id, author_id, before_content, after_content, title, image_url, is_reported,
                  is_deleted, is_hidden, emotion_type, concept_type, created_at, updated_at)
VALUES (10, 1, '내일 소풍가서 신나요.', '내일 있을 소풍 생각에 가슴이 뜁니다.', '소풍 전날',

...
|                                  [@wosyh18](https://github.com/wosyh18)                                  |                               [@qkralstjr](https://github.com/qkralstjr)                                |                                 [@prac2317](https://github.com/prac2317)                                 |                              [@Sooamazing](https://github.com/Sooamazing)                               |
|                                             게시물 관리, 반응하기 기능                                              |                                       Vertex AI 연동, 신고 처리, 욕설 감지                                        |                                          소셜 로그인, 회원 프로필, 성취 배지                                           |                                          댓글 관리, 랭킹 알고리즘, UI/UX                                          |
|                                         게시물 관리 시스템 구축, 반응 기능 구현                                          |                                        AI 프롬프트 엔지니어링, 신고 시스템 설계                                         |                                         OAuth2 인증 시스템, 배지 시스템 설계                                         |                                          전체 프론트엔드 아키텍처, 랭킹 시스템                                          |
|                               **CI/CD, AWS 인프라 구축**<br/>EC2, RDS, S3 환경 구성                               |                                  **S3 이미지 업로드 시스템**<br/>파일 업로드 및 관리 구현                                  |                                  **인증 및 보안 시스템**<br/>OAuth2, JWT 토큰 관리                                   |                                      **미리보기 기능**<br/>실시간 미리보기 시스템                                       |
